...
const FullTheme = optionsArr => {
    ...
    let rules = typographyAndColor(options.backgroundColor, '2');
...
const EmptyTheme = optionsArr => {
    ...
    let rules = typographyAndColor(options.backgroundColor, '3', options.borderColor, options.textColor);
    rules['&:hover, &.hover'] = typographyAndColor(options.hoverColor);
...
const SecondaryTheme = optionsArr => {
    ...
    let rules = typographyAndColor(options.backgroundColor, options.colorIndex, options.borderColor);
...
const CloseTheme = optionsArr => {
    ...
    let rules = transparentColor(options.color);
